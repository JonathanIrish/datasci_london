...
```
```{r install_duncan, echo=FALSE, results = "markup"}
...
```
```{r load_duncan, echo=FALSE, results = "markup"}
...
# install the last packages for UMAP, t-SNE and other tools
print("You may see a bunch of messages, this is OK as long as they are not errors.\n\n")
# TidyVerse developer version already installed in the Duncan section above
